...
export const metadata: Metadata = {
  title: {
    default: 'FreelanceHub - SaaS Freelancing Marketplace',
    template: '%s | FreelanceHub'
  },
  description: 'Professional SaaS freelancing marketplace built with Next.js 14, Supabase, and TypeScript. Developed by Ahsan Khizar.',
